...
export const formulations: Formulation[] = [
  {
    ...
    clinicalNotes: 'Preclinical and early-phase clinical evidence supports the anti-inflammatory, prokinetic, and mucosal-protective activities of the component botanicals. Cochrane-reviewed evidence exists for peppermint oil in IBS (NNT \u22483) and ginger for nausea.',
  ...
  },
  {
    ...
    otherIngredients: 'Vegetable cellulose (HPMC capsule), microcrystalline cellulose.',
    clinicalNotes: 'Meta-analysis of 13 RCTs supports Turkey Tail PSK for improved survival alongside standard oncology treatment. Curcumin inhibits CYP3A4 \u2014 significant drug interaction potential. Consult physician if on chemotherapy or narrow-TI drugs.',
  ...
  },
  {
    ...
    otherIngredients: 'Vegetable cellulose (HPMC capsule), microcrystalline cellulose.',
    clinicalNotes: 'Strong Cochrane-reviewed evidence for hawthorn in mild-to-moderate heart failure (NYHA I\u2013II). Pomegranate inhibits CYP3A4 (similar to grapefruit). Aged garlic and grape seed have mild antiplatelet activity \u2014 discontinue 7\u201310 days before surgery.',
    researchStatus: 'peer-reviewed',
  ...
  },
  {
    ...
    period: '11th\u201312th century CE',
    summary:
      'Berberis species were documented in Ibn S\u012bn\u0101\\\'s Canon of Medicine for cooling, astringent, and anti-inflammatory properties. The classical tradition described metabolic overload \u2014 failure to properly process dietary excess \u2014 as a primary generator of disease. Berberine is a potent AMPK agonist supported by 54+ systematic reviews, comparable to metformin in some metabolic parameters in head-to-head RCTs.',
    serving: '2 Capsules',
    keyIngredients: [
    ...
    otherIngredients: 'Vegetable cellulose (HPMC capsule), microcrystalline cellulose.',
    clinicalNotes: 'Inhibits CYP3A4, CYP2D6, and P-glycoprotein \u2014 the broadest drug interaction profile in the Archevia system. Consult healthcare provider before use with ANY prescription medications. May lower blood glucose \u2014 monitor if diabetic. Do not combine with metformin without physician supervision.',
    researchStatus: 'peer-reviewed',
    image: '/images/formulas/metabolic-resilience-support.png',
    dossierUrl: '/dossiers/metabolic-resilience-support-dossier.pdf',
    disclaimer: 'Consult healthcare provider before use with any prescription medications. May lower blood glucose. Not a substitute for medical supervision.',
  },
  {
    ...
    otherIngredients: 'Vegetable cellulose (HPMC capsule), microcrystalline cellulose.',
    clinicalNotes: 'Systematic review of 12 RCTs confirms NMN significantly elevates blood NAD+. Q-SYMBIO trial (Mortensen 2014): CoQ10 benefits for heart failure. Ubiquinol particularly relevant for statin users. Resveratrol has mild CYP3A4 activity.',
    researchStatus: 'peer-reviewed',
  ...
  },
  {
    ...
    otherIngredients: 'Vegetable cellulose (HPMC capsule), microcrystalline cellulose.',
    clinicalNotes: 'Kongkeaw et al. (2014) meta-analysis of 9 RCTs: significant Bacopa cognitive improvements. Hausenblas et al. (2013) meta-analysis: saffron equivalent to fluoxetine for mild-to-moderate depression. Cleanest interaction profile in the system \u2014 no CYP3A4 inhibitors, no antiplatelet agents. Effects typically require 8\u201312 weeks continuous use.',
    researchStatus: 'peer-reviewed',
    image: '/images/formulas/cognitive-vitality-complex.png',
    dossierUrl: '/dossiers/cognitive-vitality-complex-dossier.pdf',
    disclaimer: 'Bacopa may have additive effects with cholinergic medications. Saffron has mild serotonergic activity \u2014 use caution with SSRIs. High doses (>5g stigma) are toxic.',
  },
];
