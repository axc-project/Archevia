...
/* ── helpers ── */
const allHallmarks = Array.from(new Set(interventions.flatMap((i) => i.hallmarks))).sort();
const categories = Array.from(new Set(interventions.map((i) => i.category))).sort();
          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
            ...
            <div className="hidden md:block" style={{ flexShrink: 0 }}>
              <img
                ...
                alt="Cancer Across Time and Civilizations — book cover"
                width={180}
                height={270}
                style={{
                  borderRadius: '2px',
