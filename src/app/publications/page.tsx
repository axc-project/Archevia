...
const books = [
  {
    ...
    author: 'The Historical Translation Project™',
    year: '2024',
    ...
    amazonUrl: 'https://www.amazon.com/Rambams-Guide-Health-Interpretation-Preventive/dp/B0GPNWH877/',
  ...
  },
  {
    ...
    author: 'The Historical Translation Project™',
    year: '2025',
    image: '/images/brand/cancer-cover-opt.jpg',
    description:
    ...
    amazonUrl: 'https://www.amazon.com/Cancer-Across-Time-Civilizations-Translation/dp/B0GQ5C7DJZ/',
                ...
                {book.image && (
                  ...
                  >
                    <Image
                      ...
                      width={180}
                      height={260}
                      style={{ objectFit: 'contain', maxHeight: '240px', boxShadow: '0 4px 20px rgba(30,23,20,0.15)' }}
                    />
                  </div>
                )}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="fade-on-scroll">
              ...
              <p className="t-body" style={{ color: 'var(--color-ink-muted)' }}>
                Each formulation has a corresponding technical dossier with: historical manuscript
                citations, modern evidence summaries with peer-reviewed references,
                ingredient-by-ingredient rationale, safety and stacking guidance, known interaction
                profiles, and a curated reference list with PubMed links.
              </p>
