...
/* Simple markdown link parser: [text](/path) -> <a> opens in new tab to preserve chat */
...
export default function AdvisorPage() {
  ...
  function addSuggestionToCart(item: CartItem) {
    const product = getPriceBySlug(item.slug);
    if (product) {
      const formImage = `/images/formulas/${item.slug}.png`;
      addItem(product, formImage);
    }
  }

  function addAllSuggestionsToCart() {
    suggestions.forEach((item) => addSuggestionToCart(item));
  }
  ...
  return (
    <>
      ...
      <section className="section" style={{ paddingBlock: 'clamp(1.5rem, 3vw, 2.5rem)' }}>
        <div className="container" style={{ maxWidth: '58rem' }}>
          <div className={suggestions.length > 0 ? 'grid md:grid-cols-[1fr,280px] gap-6' : ''}>
            {/* Chat panel */}
            <div className="card-manuscript" style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              {/* Messages */}
              <div ref={chatRef} className="flex-1 overflow-y-auto p-5 space-y-4" style={{ maxHeight: '520px' }}>
                {messages.length === 0 && (
                ...
                <div className="card-manuscript p-5">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2 mt-1">
                            <button
                              ...
                              className="text-xs"
                              style={{ color: 'var(--color-emerald)', textDecoration: 'underline', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: 'var(--font-jost)' }}
                            >
                              Add to Cart
                            </button>
                            <Link
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <button
                      ...
                      className="t-label block w-full text-center"
