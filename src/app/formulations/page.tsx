  ...
  return (
    <>
      <PageHero
        ...
        arabicAttribution="Avicenna, Al-Qānūn, Book II — 'The compound remedy is stronger than the simple one.'"
      />

      <DisclaimerBanner />

      {/* Bottles hero image */}
      <section style={{ background: 'var(--color-ink)', overflow: 'hidden' }}>
        <div className="container" style={{ maxWidth: '64rem', paddingBlock: '2rem' }}>
          <img
            src="/images/brand/bottles-hero.jpg"
            alt="Archevia™ supplement formulations — Digestive Metabolic Core, Cellular Resilience Core, Circulatory Cardio Core, Urinary Tract Core"
            width={1200}
            height={500}
            style={{
              width: '100%',
        ...
        <div className="container">
          ...
          >
            ...
            <p className="t-body" style={{ color: 'var(--color-ink-muted)' }}>
              ...
              currently under translation and review and will be published as new sources
              are analysed.
            </p>
          </div>
        </div>
