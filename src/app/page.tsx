...
export const metadata: Metadata = {
  title: 'Archevia™ — Evidence-Based Botanical Formulations',
};
    ...
    <>
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '70vh' }}>
        ...
        <div
          ...
          style={{
            backgroundImage: 'url(/images/brand/hero-bg-opt.jpg)',
        ...
        <div
          className="absolute inset-0"
          style={{ background: 'linear-gradient(160deg, rgba(30,23,20,0.82) 0%, rgba(30,23,20,0.65) 100%)' }}
        />
        ...
        <div className="container relative" style={{ paddingBlock: 'clamp(6rem,12vw,10rem)' }}>
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-3 mb-8 fade-on-scroll">
              ...
              <span className="t-label" style={{ color: 'var(--color-accent)' }}>
                Archevia™ · In Collaboration with the Historical Translation Project™
              </span>
            </div>

            {/* Headline */}
            <h1
              className="t-display mb-6 fade-on-scroll"
              style={{ animationDelay: '0.1s', color: 'var(--color-bg)' }}
            >
            ...
            >
              Evidence-based botanical formulations grounded in the canonical Islamic-Jewish
              medical corpus — from Maimonides&rsquo; <em>Regimen of Health</em>{' '}
              to Avicenna&rsquo;s <em>Canon of Medicine</em> — translated, authenticated,
              and mapped to modern phytochemistry.
            </p>
            ...
            <div className="flex flex-wrap gap-4 fade-on-scroll" style={{ animationDelay: '0.3s' }}>
              ...
              <Link
                ...
                style={{ color: 'rgba(253,248,240,0.8)', borderColor: 'rgba(253,248,240,0.25)' }}
              >
          ...
          <div
            ...
            style={{ animationDelay: '0.4s', background: 'rgba(253,248,240,0.95)' }}
          >
            ...
            <p className="italic text-sm" style={{ color: 'var(--color-ink-muted)' }}>
              "Health is better than wealth."
            </p>
            <p className="t-label mt-3" style={{ color: 'var(--color-ink-faint)' }}>
        ...
        <div className="container">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Every Archevia formulation begins with original manuscripts from the Islamic-Jewish
                medical tradition, translated and analysed using AI-assisted tools to identify
                modern botanical equivalents backed by peer-reviewed scientific evidence.
              </p>
            ...
            <div className="space-y-6">
              {[
                { n: '01', title: 'Manuscript Translation', desc: 'Translation of original Arabic and Hebrew medical texts into English.' },
                { n: '02', title: 'AI-Assisted Identification', desc: 'Matching classical botanical names to modern species and compounds.' },
                { n: '03', title: 'Evidence Review', desc: 'Cross-referencing each ingredient against PubMed, Cochrane, and clinical trial data.' },
                { n: '04', title: 'Formulation Development', desc: 'Building evidence-based formulations with documented dosing and safety profiles.' },
              ].map((step, i) => (
                <div
                  key={step.n}
      ...
      <section className="section" style={{ background: 'var(--color-bg-alt)', borderTop: '1px solid var(--color-border)' }}>
        <div className="container">
          <div className="grid md:grid-cols-[1fr_220px] gap-12 items-start">
            {/* Left column: text + pathway cards */}
            <div>
              <div className="flex items-center gap-3 mb-4">
                <span className="geo-diamond" />
                <span className="t-label" style={{ color: 'var(--color-accent)' }}>New Research Tool</span>
              </div>
              <h2 className="t-heading-1 mb-4 fade-on-scroll">Pathway Explorer</h2>
              <p className="t-body mb-6 fade-on-scroll" style={{ color: 'var(--color-ink-muted)', maxWidth: '36rem' }}>
                An interactive, searchable database of 37 interventions, 16 molecular pathways,
                and 61 peer-reviewed publications — extracted from the appendices of{' '}
                <em>Cancer Across Time and Civilizations</em>. Designed for researchers,
                clinicians, and informed patients.
              </p>
              <div className="flex flex-wrap gap-4 mb-8 fade-on-scroll">
                <Link href="/pathways" className="btn btn-gold">
                  Explore Pathways
                </Link>
              ...
              <div className="space-y-3 fade-on-scroll">
                {[
                  { pathway: 'NF-κB Suppression', count: 9, hallmark: 'Inflammation' },
                  { pathway: 'mTOR Inhibition', count: 5, hallmark: 'Metabolic reprogramming' },
                  { pathway: 'Caspase / Apoptosis', count: 10, hallmark: 'Resistance to apoptosis' },
                  { pathway: 'Immune Activation (NK/DC/T-cell)', count: 10, hallmark: 'Immune evasion' },
                  { pathway: 'VEGF / Angiogenesis Suppression', count: 6, hallmark: 'Angiogenesis' },
                ].map((p) => (
                  <Link
                    key={p.pathway}
                    href="/pathways"
                    className="card-manuscript block p-4"
                  ...
                  >
                    ...
                    <span style={{ fontSize: '0.65rem', color: 'var(--color-ink-faint)' }}>#{p.hallmark}</span>
                  </Link>
                ))}
              </div>
            </div>
            ...
            <div className="hidden md:flex flex-col items-center pt-8">
              <img
                src="/images/brand/cancer-cover-opt.jpg"
                alt="Cancer Across Time and Civilizations — A Historical and Biological Translation"
                width={200}
                style={{
              ...
              >
                Cancer Across Time<br />and Civilizations
              </p>
              <p style={{ fontFamily: 'var(--font-ibm-mono)', fontSize: '0.6rem', color: 'var(--color-ink-faint)' }}>
                210 pages · 36 chapters · 134 endnotes
              </p>
            </div>
          </div>
        </div>
